...
var CORRIDOR_DETAILS = [
  { id: "Corredor 1" /* CORREDOR_1 */, name: "Corredor 1", color: "#007BFF" },
  { id: "Corredor 2" /* CORREDOR_2 */, name: "Corredor 2", color: "#DC3545" },
  { id: "Corredor 3" /* CORREDOR_3 */, name: "Corredor 3", color: "#D2B48C" },
  { id: "Corredor 4" /* CORREDOR_4 */, name: "Corredor 4", color: "#6C757D" },
  { id: "Corredor 5" /* CORREDOR_5 */, name: "Corredor 5", color: "#FD7E14" },
  { id: "Corredor 6" /* CORREDOR_6 */, name: "Corredor 6", color: "#0DCAF0" },
  { id: "Corredor 7" /* CORREDOR_7 */, name: "Corredor 7", color: "#FFC107", textColor: "#333333" },
  { id: "Corredor 8" /* CORREDOR_8 */, name: "Corredor 8", color: "#198754" },
  { id: "Troncales" /* TRONCALES */, name: "Troncales", color: "#C8A2C8" },
  { id: "Metropolitano" /* METROPOLITANO */, name: "Metropolitano", color: "#98FB98" },
  { id: "Otro Corredor/Zona" /* OTRO */, name: "Otro Corredor/Zona", color: "#adb5bd" }
];
...
var DiversionCard = ({ diversion }) => {
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300 flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxs3("div", { className: "p-6 flex-grow flex flex-col", children: [
      /* @__PURE__ */ jsxs3("div", { className: "mb-3", children: [
        ...
        /* @__PURE__ */ jsxs3("p", { className: "text-sm text-gray-500", children: [
          "L\xEDnea(s): ",
          /* @__PURE__ */ jsx3("span", { className: "font-medium text-dark", children: diversion.lines.join(", ") })
        ] })
      ] }),
      typeDetail && /* @__PURE__ */ jsxs3("div", { className: "flex items-center text-sm text-gray-600 mb-2", children: [
      ...
      /* @__PURE__ */ jsxs3("div", { className: "mt-auto pt-3 border-t border-gray-200", children: [
        diversion.estimatedDuration && /* @__PURE__ */ jsxs3("p", { className: "text-xs text-gray-500 mb-1", children: [
          /* @__PURE__ */ jsx3("span", { className: "font-semibold", children: "Duraci\xF3n:" }),
          " ",
          diversion.estimatedDuration
        ] }),
        /* @__PURE__ */ jsxs3("p", { className: "text-xs text-gray-400", children: [
          "Publicado: ",
...
var App = () => {
  ...
  const handleAddMultipleDiversions = useCallback2((newDiversions) => {
    ...
    alert(`${newDiversions.length} desv\xEDos agregados desde archivo. (Revisar y persistir)`);
    setIsAdminView(false);
  }, []);
  ...
  return /* @__PURE__ */ jsxs5("div", { className: "flex flex-col min-h-screen bg-gray-100", children: [
    ...
    /* @__PURE__ */ jsx5("main", { className: "container mx-auto p-4 sm:p-6 lg:p-8 flex-grow w-full", children: isAdminView ? /* @__PURE__ */ jsx5(
      ...
      /* @__PURE__ */ jsxs5("div", { className: "mb-8 p-6 bg-white rounded-lg shadow-md", children: [
        /* @__PURE__ */ jsx5("h2", { className: "text-xl font-semibold text-primary mb-4", children: "Filtrar Desv\xEDos" }),
      ...
      filteredDiversions.length > 0 ? /* @__PURE__ */ jsx5("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: filteredDiversions.map((diversion) => /* @__PURE__ */ jsx5(DiversionCard_default, { diversion }, diversion.id)) }) : /* @__PURE__ */ jsxs5("div", { className: "text-center py-12 bg-white rounded-lg shadow p-8", children: [
